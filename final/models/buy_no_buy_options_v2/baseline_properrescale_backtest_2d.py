...
df = pd.read_parquet(OUT_DIR / "options_calls_expanded_pit_properrescale_v3_2d.parquet")
...
with open(OUT_DIR / "baseline_properrescale_results_2d.json", "w") as f:
    json.dump(per_timepoint, f, indent=2, default=str)
print("\nsaved baseline_properrescale_results_2d.json")
