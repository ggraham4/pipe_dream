...
pairs = pd.read_parquet(OUT_DIR / "entry_expiration_pairs_60d.parquet")
...
calls.to_parquet(OUT_DIR / "raw_calls_at_entry_60d.parquet")
print("wrote raw_calls_at_entry_60d.parquet", flush=True)
